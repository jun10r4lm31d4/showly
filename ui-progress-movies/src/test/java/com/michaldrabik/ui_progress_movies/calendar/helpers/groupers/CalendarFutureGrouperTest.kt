...
class CalendarFutureGrouperTest : BaseMockTest() {
  ...
  fun `Should group past items by time properly`() =
    runTest {
      ...
      assertThat((results[0] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textToday)
      assertThat((results[1] as CalendarMovieListItem.MovieItem)).isEqualTo(item1)
      assertThat((results[2] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textTomorrow)
      assertThat((results[3] as CalendarMovieListItem.MovieItem)).isEqualTo(item2)
      assertThat((results[4] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textThisWeek)
      assertThat((results[5] as CalendarMovieListItem.MovieItem)).isEqualTo(item3)
      assertThat((results[6] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textNextWeek)
      assertThat((results[7] as CalendarMovieListItem.MovieItem)).isEqualTo(item4)
      assertThat((results[8] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textThisMonth)
      assertThat((results[9] as CalendarMovieListItem.MovieItem)).isEqualTo(item5)
      assertThat((results[10] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textNextMonth)
      assertThat((results[11] as CalendarMovieListItem.MovieItem)).isEqualTo(item6)
      assertThat((results[12] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textThisYear)
      assertThat((results[13] as CalendarMovieListItem.MovieItem)).isEqualTo(item7)
      assertThat((results[14] as CalendarMovieListItem.Header).textResId).isEqualTo(com.michaldrabik.ui_base.R.string.textLater)
